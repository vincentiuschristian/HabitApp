...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val imgPriority: ImageView = itemView.findViewById(R.id.pager_priority_level)
        private val btnStart: Button = itemView.findViewById(R.id.btn_open_count_down)
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            imgPriority.setImageResource(priorityColor)
